...
注释要求:对于每一个循环,还有if添加注释
代码正文以模块为单位添加注释,用一句话剪短表示当前模块调用做的事情
全局变量需要标注是什么意思
...
```powershell
& \venv\Scripts\python.exe C:\Users\winkey\Desktop\网站研究\playwright\spider_learn\tests\test_xxx_module.py
```
