    ...
    *,
    ...
    for attempt_index in range(attempts):
        try:
            ...
            if not text:
                logger.warning(
                    "[folder_patents_abstract] empty abstract payload patent_id={} payload_summary={}",
                    patent_id,
            ...
            if text in {"0", "0.0"}:
                logger.warning(
                    "[folder_patents_abstract] suspicious abstract patent_id={} text={} payload_summary={}",
                    patent_id,
                    text,
                    summarize_abstract_payload(payload),
                )
            ...
            logger.warning(
                "[folder_patents_abstract] retry abstract patent_id={} attempt={}/{} error={} sleep={}s",
                patent_id,
                attempt_index + 1,
                attempts,
                exc,
    ...
    *,
    ...
    for row_index, row in enumerate(patents_data):
        ...
        try:
            ...
            logger.warning(
                "[folder_patents_abstract] abstract failed patent_id={} row_index={} error={}",
                patent_id,
                row_index,
                exc,
            )
