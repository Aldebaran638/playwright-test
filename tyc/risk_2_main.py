...
from tyc.modules.browser.context import launch_tyc_browser_context, save_cookies
from tyc.modules.navigation.go_to_home import go_to_home_page
from tyc.modules.browser.login_state import wait_until_logged_in
...
def load_companies_from_file() -> List[str]:
    ...
    Returns:
        公司名称列表
    """
    name_list_path = Path(__file__).resolve().parent / "modules" / "name_list_test.txt"
